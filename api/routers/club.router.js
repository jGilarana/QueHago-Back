...
const {updateOwnClub, getAllClubs, getOneClub, createClub, updateClub, deleteClub, createClubsEvent, getClubsEvents, getOwnClub} = require('../controllers/club.controller')
...
router.get('/ownclub', checkAuth, getOwnClub)
